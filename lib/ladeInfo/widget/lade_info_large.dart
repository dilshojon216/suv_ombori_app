...
class LadeInfoLarge extends StatefulWidget {
  const LadeInfoLarge({Key? key}) : super(key: key);

  @override
  _LadeInfoLargeState createState() => _LadeInfoLargeState();
}

class _LadeInfoLargeState extends State<LadeInfoLarge> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      children: [
        ...
        //   children: [
        //     Expanded(
        //       child: conternerList(6),
        //       flex: 1,
        //     ),
        //     Expanded(
        //       child: conternerList(7),
        //       flex: 1,
        //     ),
        //     Expanded(
        //       child: Container(),
                        ...
                        child: Container(
                          ...
                          child: sensorBool[index]
                              ? Container(
                                  height: 35,
                                  child: TextField(
                                    controller: sensorLavelController[index],
                                    style: TextStyle(fontSize: 20),
                                  ))
                              : CustomText(
                                  text: sensors![index].sensorLavel,
                                  size: 20,
                                  weight: FontWeight.bold,
                                ),
                        ),
