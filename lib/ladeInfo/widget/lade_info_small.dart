...
class LadeInfoSmall extends StatefulWidget {
  const LadeInfoSmall({Key? key}) : super(key: key);

  @override
  _LadeInfoSmallState createState() => _LadeInfoSmallState();
}

class _LadeInfoSmallState extends State<LadeInfoSmall> {
