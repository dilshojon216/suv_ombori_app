...
class _OverviewCardsSmallScreenState extends State<OverviewCardsSmallScreen> {
  ...
  void initState() {
    ...
    getOnlineData();
    getTodayData();
    timer = Timer.periodic(Duration(seconds: 20), (Timer t) => getOnlineData());
    timer1 =
        Timer.periodic(Duration(seconds: 600), (Timer t) => getTodayData());
  }
...
String timeS(String time) {
  ...
  if (formattedDate.substring(0, 2) == time.substring(0, 2)) {
    ...
    return "Qurilmada noso'zlik mavjud";
  }
}
