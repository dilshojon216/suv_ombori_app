...
class UserInfoCardSmall extends StatefulWidget {
  ...
  const UserInfoCardSmall({Key? key, this.userModel}) : super(key: key);
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  nameContiner(widget.userModel!.name, nameController, namebool,
                      editNameBtn, closeNameBtn, true)
                ],
              ),
            ),
            flex: 1,
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  nameContiner(widget.userModel!.lastname, lastNameController,
                      lastnamebool, editLastNameBtn, closeLastNameBtn, true),
                ],
              ),
            ),
            flex: 1,
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  nameContiner(widget.userModel!.username, usernameController,
                      usernamebool, editUsernameBtn, closeUsername, true),
                ],
              ),
            ),
            flex: 1,
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  nameContiner("*******", passwordController, passwordbool,
                      editPasswordBtn, closePasswordBtn, true),
                ],
              ),
            ),
            flex: 1,
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  nameContiner(widget.userModel!.phone, phoneController,
                      phonebool, editPhoneBtn, closePhoneBtn, true),
                ],
              ),
            ),
            flex: 1,
