...
class UserInfoCardMedium extends StatefulWidget {
  final UserModel? userModel;
  const UserInfoCardMedium({Key? key, this.userModel}) : super(key: key);

  @override
  _UserInfoCardMediumState createState() => _UserInfoCardMediumState();
}

class _UserInfoCardMediumState extends State<UserInfoCardMedium> {
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      nameContiner(widget.userModel!.name, nameController,
                          namebool, editNameBtn, closeNameBtn, true),
                    ],
                  ),
                )),
                Expanded(
